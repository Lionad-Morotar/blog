...
![An Evening in Southwold](./assets/200319/browser_c5Q2Z8gnR9.jpg)
...
![sea line](./assets/200319/browser_a5aNdMBsJV.png)

再定位父元素的 `::before` 及 `::after` 伪元素，查看控制台的样式面板，可以知道横线是由 box-shadow 属性绘制的，如下图：

![sea line box-shadow](./assets/200319/browser_79GatmjU32.png)
...
![房屋](./assets/200319/2020-03-19-14-20-58.png)

![房屋](./assets/200319/h6yxZsWcU3.gif)
...
![sea line box-shadow](./assets/200319/browser_0pEYpYHqlu.png)
...
![结果](./assets/200319/2020-03-19-09-31-44.png)
...
![逐渐消失](./assets/200319/2020-03-19-14-08-01.png)

这是因为接近太阳倒影的地方，作者加了一层颜色与水面纹理颜色相同的渐变。如果我们去掉这层渐变，就会发现“逐渐消失”其实是一种错觉，水面纹理一直存在：

![错觉](./assets/200319/2020-03-19-14-12-32.png)

### 太阳及其炫光

![太阳及其炫光](./assets/200319/2020-03-19-15-39-43.png)
