...
<form id="js-100-2" action="" onsubmit="return false">
  ...
  <details open>
    ...
    <p>总的来说，isNaN 会对传入的值进行 toNumber 转换，而 Number.isNaN 不会。Number.isNaN 是一种比 isNaN 语义更“正确”的版本。</p>
    <p>Number.isNaN 算法见<a href="https://www.ecma-international.org/ecma-262/6.0/#sec-number.isnan" target="_blank" rel="nofollow">规范</a>：</p>
