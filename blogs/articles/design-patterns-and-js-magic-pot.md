...
从《人月神话》到《大教堂与集市》许多闻名业界的作品都“低代码、高文化[^文化]”；各种代码文化运动也可以看作“造神运动”此类周日剧场。许多大佬都很希望不止使用代码，而是更多地通过文化手段，不论是哲学思想还是艺术内涵，来统一人与代码的关系。这种跨界的思考通常很晦涩，诸如“面向对象”、“设计模式”这些放到现在我们耳熟能详的词，在过去几十年都是由行业顶尖大佬们牵头搞研究搞出来的东西。再经过不断地实践与演进，逐渐形成标准，沉淀下来。

[^文化]: 非贬义。

设计模式就是一种标准，词本身发源于建筑学作品《建筑模式语言》，后被一个人们称为“四人帮”（GoF）的小组种出其在软件界的新花。无论是建筑学还是软件学中的设计模式，相同的地方是，它们都想解决“人”和“物”的关系相关问题，并且作为标准沉淀下来。好比人们有了灶就可以长久保存火种，用名词把晦涩难懂的抽象定义下来，这样有利于思想传播。

**设计模式是一种标准，它描述了使用面向对象编程语言解决问题的方式。**

## 为什么非面向对象不可

为什么非面向对象不可？有些教科书不是又说设计模式是用来描述软件开发人员在软件开发过程中面临的一般问题的解决方案吗？

<!-- 四人帮成员都是用面向对象的大佬，比方说 Erich Gamma，他是 Eclipse 和 JUnit 的作者。他们写程序摸爬滚打几十年， -->
其实，TODO，所以写书时也就按照面向对象写了，没毛病。
