...
2. 情境管理（Context management for long-horizon tasks）<br />
...
3. 动态信息检索（Dynamic information retrieval）<br />
...
1. 什么是上下文工程
2. 上下文工程 vs 提示工程
3. 上下文工程的三大方向（架构颗粒度）<br />


3.1 情境搭建（Context Setup）<br />


3.2 情境管理：长周期任务（Context Management）<br />
...
上下文工程是在推理阶段，对“喂给大模型的所有信息”进行整体设计和优化的一套方法论与工程实践。<br />
...
3.3.1 核心思想：JIT（Just-in-Time）<br />
