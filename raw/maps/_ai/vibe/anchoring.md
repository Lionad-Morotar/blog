# Anchoring coding agents to a ref application

> 在编码代理时代，通过将其锚定至实时可编译的参考应用，有效应对代码漂移问题

## Brief

将编码代理锚定至参考应用：定制化服务模板虽能快速启动微服务并无缝集成基础设施，但随新依赖、框架和架构模式出现，模板与现有服务间代码漂移问题日益严重。为应对编码代理时代挑战，我们通过实时可编译的参考应用替代静态提示示例来引导生成式代码代理。
MCP 服务器暴露模板源码及提交差异，使代理能自动检测漂移并提出修复。此方法将静态模板转化为智能活体蓝图，在系统演进中有效维持一致性、减少偏离并提升对 AI 脚手架的控制力。
...
微服务架构中，定制化服务模板曾有效支撑新服务快速启动及基础设施集成。然而，技术栈持续演进（如新依赖引入、框架升级或架构模式迭代）导致模板与生产环境服务逐渐脱节，形成代码漂移。尤其在编码代理广泛应用的当下，静态模板难以动态响应变化，
加剧了架构实践与实际开发的脱节。
