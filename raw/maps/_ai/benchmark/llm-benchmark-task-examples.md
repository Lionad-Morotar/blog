# LLM Benchmark 原始任务示例集

> SimpleQA、HLE、Apex Shortlist、Codeforces、SWE Verified、Terminal Bench 2.0、Toolathlon 的原始任务示例。
...
<thead>
  <tr>
    ...
    <th>
      示例（问题："哪位荷兰球员在 2022 年荷兰 vs 阿根廷的男足世界杯比赛中打入了运动战进球？" 答案：Wout Weghorst）
    </th>
  </tr>
</thead>
...
<tbody>
  <tr>
    ...
    <td>
      预测答案完全包含正确答案，且不与参考答案矛盾
    </td>
    
    <td>
      "Wout Weghorst" / "Wout Weghorst 在那场比赛的第 83 分钟和第 90+11 分钟进球"
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      预测答案以任何方式与正确答案矛盾，即使是模糊地
    </td>
    
    <td>
      "Virgil van Dijk" / "Virgil van Dijk 和 Wout Weghorst" / "Wout Weghorst，不过我觉得 van Dijk 也进了，但不太确定"
    </td>
  </tr>
...
Google 在 2025 年发布的改进版本，通过搜索引擎增强的模型 ensemble 对原始数据集中的冲突来源进行调和，进一步提高了基准的可靠性。<sup>

[1](#user-content-fn-simpleqa-verified)
...
GPT-4o 在最佳 scaffold 上达到 33.2%（原始 SWE-bench 为 16%）。Claude Mythos Preview 目前领先，达 93.9%。<sup>

[2](#user-content-fn-swe-bench-verified)
...
<tbody>
  <tr>
    ...
    <td>
      实现自适应拒绝采样器（adaptive-rejection sampler）
    </td>
  </tr>
...
1. [SimpleQA Verified: A Reliable Factuality Benchmark](https://arxiv.org/pdf/2509.07968), Google, 2025 [↩](#user-content-fnref-simpleqa-verified)
2. [SWE-bench Verified](https://www.swebench.com/verified.html), Princeton + OpenAI, 2024 [↩](#user-content-fnref-swe-bench-verified)
