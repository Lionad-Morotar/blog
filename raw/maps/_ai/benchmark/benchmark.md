...
- [2026 年了，谁画页面更强一些](./frontend-copy)

## Local Benchmark

**M3 Max 128GB**

- [qwen3.5-9b-mlx-4bit](./local/qwen3.5-9b-mlx-4bit)
- [qwen3-coder-next-mlx-4bit](./local/qwen3-coder-next-mlx-4bit)
...
- [qwen3-embedding-8b-4bit-dwq](./local/qwen3-embedding-8b-4bit-dwq)
- [glm-ocr-8bit](./local/glm-ocr-8bit)
