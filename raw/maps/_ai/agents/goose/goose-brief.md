...
- Follow best practices for Markdown, including:
  ...
  links using angle brackets (e.g., [http://example.com/](http://example.com/)).
...
3rd party extensions can be browsed at [https://block.github.io/goose/v1/extensions/](https://block.github.io/goose/v1/extensions/).
