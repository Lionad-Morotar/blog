...
Web Origami 作者 Jan Miksovsky 的示范：当用户"拿错了"（holding it wrong）时，工具建造者的第一反应是内省——技术是否没有对齐用户的真实期望。人本设计允许困惑被看作设计失败的信号，
而不是用户愚蠢的证据。许多技术倡导者口头上声称自己"以人为本"，但当失败响应是"去学技术"时，其实践已经背叛了这一立场。这种技术中心主义的姿态人为制造了技能天花板，培育出精通"正确咒语"的祭司阶层，把其他人挡在门外。
