...
CSS 3 之后，CSS 不再是一个单独的、涵盖所有内容的大规范，而是拆分成了注入滚动条、MediaQuery 之类的模块型小规范。CSS Snapshot 文档用于确定在某个时间节点上，各模块 CSS 规范的完成情况（是否稳定），
即 Working Draft(WD)、Candidate Recommendation(CR) 和 Recommendation(REC)。

见：[CSS 2024@W3C](https://www.w3.org/TR/2025/NOTE-css-2024-20250225/)，这份文档除了规范稳定性快照以外，还有完整的 CSS 术语表。
...
- [CSS Transitions Level 1](https://www.w3.org/TR/css-transitions-1/) and [CSS Animations Level 1](https://www.w3.org/TR/css-animations-1/)
