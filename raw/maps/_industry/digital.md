...
> 从商业角度而言，数字化是指将业务过程和流程转变为数字形式，以提高效率、创造价值和增加收入。数字化是一个广泛的概念，包括数字化技术、数字化转型、数字化营销等等。
...
, "almost free" products makes Orgs bending huge tech stack and increase the number of "
Shadow ITs"
- <q>
...
We use Zero Trust Network Access instead of VPN

</q>
- <q>

Collaborate with private and nonprofit peers ... have similar digital transformation objectives and challenges
...
#### 中国制造业数字化转型的政策目标与实施路径？

2024 年 7 月，工信部发布《制造业数字化转型行动方案》，明确了"点线面"同步发力的实施路径：

**现状数据：**

- 中国工业机器人装机量占全球比重超过 50%
- 全球 153 座灯塔工厂中，中国有 62 座（占比超 40%）
- 示范工厂产品研发周期缩短约 30%，生产效率提升近 30%

**政策目标：**

- **2027 年**：工业大省大市和重点园区规上工业企业实现数字化改造全覆盖，建成 200 个左右高标准数字园区
- **2030 年**：规上工业企业基本完成一轮数字化改造

**实施路径：**

- **"点"**：聚焦链主企业、专精特新中小企业，优先推动装备制造、大宗耐用消费品生产、大规模设备更新企业的数字化改造
- **"线"**："一链一策"开展重点产业链数字化协同改造，支持链主企业开放数据接口，打造数字化供应链
