...
比如 HelloWorld 中的 onCommand 便意味着在 VS Code 中使用 <keyboard>

Ctrl + P

</keyboard>

 输入指令时可以激活 vscode-plugin-demo.helloWorld 指令。
...
脚手架默认生成了调试插件所需要的配置，存放在了 .vscode 文件夹中。只需要按 <keyboard>

F5

</keyboard>

 键就可以在新窗口启动当前插件查看运行效果。如果你对插件有修改，
可以 <keyboard>
...
Shift + F5
 ...
 停用插件后再重开，或者直接在新窗口使用 <keyboard>

Ctrl + R

</keyboard>

 重载（或使用指令 Reload Window）。
