...
- 数组处理：[https://1loc.dev/array/](https://1loc.dev/array/)
...
- 保密性、数据量、POST
- 勘误：POST 并不比 GET "更安全"，两者在 HTTPS 下传输层安全性相同。POST 的优势仅在于 body 不会出现在浏览器历史和服务器日志中，但真正的安全依赖 HTTPS 而非方法选择
