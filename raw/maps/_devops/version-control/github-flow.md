...
> GitHub Flow 是一种基于 PR 的轻量级 Git 工作流，由 GitHub 团队提出。

## Quick Questions

#### GitHub Flow 是什么？

GitHub Flow 是一种基于 PR 的轻量级 Git 工作流，由 GitHub 联合创始人 Scott Chacon 于 2011 年提出。核心原则只有一条：**main 分支上的任何内容都随时可部署。** 在此工作流中，
所有功能开发都在独立的 feature 分支上进行，通过 Pull Request 完成审查后合并回 `main`，合并即部署。
