...
> 上下文压缩会导致模型性能降低，你需要在特定的模型推迟自动压缩的时机
...
比如我日常使用的模型支持 256K context，我会把目标窗口设到 270000，这样自动压缩的触发点会从 167k 明显后移到 237k。默认 CC 有约 30k 的压缩预留区，设置到 270k 后，长任务比如重构、多文件阅读，
会舒服非常多。
...
[https://github.com/Lionad-Morotar/cc-expand](https://github.com/Lionad-Morotar/cc-expand)
