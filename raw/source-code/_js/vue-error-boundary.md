...
错误边界（Error Boundaries）是 17 年时 React 中出现的一种概念，它指出：组件渲染、生命周期时出现的错误不应导致整个应用的崩溃<sup>

[1](#user-content-fn-error-boundary)

</sup>

。使用错误边界能捕获组件的错误并回退到特定组件。
...
1. [https://reactjs.org/docs/error-boundaries.html#gatsby-focus-wrapper](https://reactjs.org/docs/error-boundaries.html#gatsby-focus-wrapper) [↩](#user-content-fnref-error-boundary)
