...
> JavaScript Intrinsics 缓存与防御性编程，ljharb 的 es-shims 生态系统核心库
...
<tbody>
  ...
  <tr>
    ...
    <td>
      提供标准库 polyfill，可检测原生方法是否被篡改（<code>
        .sham
      </code>
  ...
  <tr>
    ...
    <td>
      通过 iframe 获取干净全局对象，配合 Proxy 拦截
    </td>
