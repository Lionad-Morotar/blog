...
最近在复习 HTML 相关内容呢，不知不觉想起以前在实习公司用过的 html5shiv 这个玩意儿。html5shiv 能使 IE6/7/8 等浏览器支持 HTML5 的新标签<sup>

[1](#user-content-fn-html5shiv)
...
以前没听过 HTMLElement.hidden，项目里的隐藏元素都是直接上 CSS 做的。不过据 MDN 表示，除了隐藏元素之外，hidden 属性还能用于创造离屏 Canvas<sup>

[2](#user-content-fn-hidden)
...
1. [html5shiv](https://github.com/aFarkas/html5shiv) [↩](#user-content-fnref-html5shiv)
2. [HTMLElement.hidden@MDN](https://developer.mozilla.org/zh-CN/docs/Web/API/HTMLElement/hidden) [↩](#user-content-fnref-hidden)
