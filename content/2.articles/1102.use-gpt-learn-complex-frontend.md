...
无论是模型性能，还是应用层基础，这几年 AI 工具工程化落地的速度越来越快，在各个领域大放异彩。

本文原有的提倡通过 LLM 发散思维能力来学习具体知识的观点可以进一步进化。目前没有成文，但 2025 FEDAY 中天翔的演讲“AI 编程认知税”中提到的认知税概念很适合作为扩展：

他将任务难度（不仅仅是学习任务）从不等的上下文约束程度划分为 0-10 等级，分别是 0-3分纯发散区，3-8分探索地狱，和8-10分有限游戏。举个例子，“给我的按钮做10种动效（然后我选一种）”是0-3分任务，其中"认知税"，即验证、修正AI输出的时间较低。

具体见：[AI 编程的"认知税" - 天翔 @youtube](https://www.youtube.com/watch?v=y6_KaNfkZ8c)
