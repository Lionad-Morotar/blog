...
当数据工程与业务域团队缺乏紧密协作时，数据工程师往往拿不到足够的业务上下文，难以设计真正有意义、可被广泛采用的数据产品，业务价值也因此打折。更合理的模式是：数据平台团队专注于建设和维护共享基础设施，
而跨职能的业务领域团队在其上构建并拥有自己的数据产品，遵循 data mesh 的原则。我们将“独立数据工程团队”实践标记为 Hold，是为了强烈反对这种组织割裂，尤其是在对“具备丰富领域语义、可用于 AI 的数据”需求快速增长的当下。
