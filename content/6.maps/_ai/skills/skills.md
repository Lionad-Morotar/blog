...
- **Perplexity 的 Skill 工程实践**：Perplexity Computer 的 Agent Skills 系统采用三层渐进式加载（Index / Load / Runtime），description 作为路由触发器而非文档，并通过 gotcha 飞轮机制持续维护 Skill 质量。见 [Designing, Refining, and Maintaining Agent Skills at Perplexity](https://research.perplexity.ai/articles/designing-refining-and-maintaining-agent-skills-at-perplexity)[^1]
