...
- L1: 2026年3月31日 Claude Code 源码泄露暴露的运行时问题包括：7 个进程占用 5.3 GB RAM，单个进程峰值分配 36.5 GB，另一进程 5 分钟内堆内存达 93 GB；同月发生 8 次服务中断。`autoCompact.ts` 中记录约 1,279 个会话出现 50+ 连续失败（最高达 3,272 次），每天浪费约 25 万次 API 调用，修复仅 3 行代码。
- L1: 问题追踪系统高度自动化：估计 26,792 个 issue 关闭中有 49-71% 由机器人驱动；Issue #38335 获 201 个赞、被标为”invalid”、零团队回应。
- L2: Anthropic 首席工程师 Boris Cherny 对泄露的回应是”通过更快、更多自动化和让 Claude 检查结果来解决问题”——这被解读为一种结构性信号：当 AI 系统失败时，组织的本能反应是引入更多 AI，而非更多人类审查。
