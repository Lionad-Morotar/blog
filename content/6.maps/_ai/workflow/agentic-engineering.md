...
具体实践案例（工程 sprint 规划）：AI agent 访问 Linear tickets、Slack 工程频道、客户反馈、GitHub、Notion 高层计划、销售电话录音和站会记录，综合分析上一 sprint 的实际交付与客户真实需求匹配度，进而提出更准确的未来 sprint 计划。
...
Jack Dorsey 在 Block 的实践得出同样结论：保持相同的组织结构图和管理结构，就完全错过了这个转变。他提出未来公司将有三种员工原型，第一种是 **IC（Individual Contributor，建造者和操作者）**——在 AI Native 公司中，不仅限于工程师，支持、销售等所有人都构建和操作，每个人都带着**可工作的原型而非 PPT** 来开会。
