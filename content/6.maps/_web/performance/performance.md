...
Core Web Vitals 包含 <abbr title="Largest Contentful Paint">LCP</abbr>、<abbr title="Interaction to Next Paint">INP</abbr>、
<abbr title="Cumulative Layout Shift">CLS</abbr>，分别衡量加载性能、交互响应和视觉稳定性。LCP 需在 2.5 秒内完成，INP 需在 200 毫秒内响应，CLS 需保持在 0.1 以下。
