...
GPS L1 C/A 导航电文中有一个 176 位的“特殊信息”字段（Subframe 4, Page 17），IS-GPS-200 规范将其内容交由作战司令部自行决定。伦敦大学学院安全工程教授 Steven Murdoch 等人分析了 2007 年至 2026 年初超过 1216 万条该字段观测记录，发现其内容并非文本而是加密数据，且与美国军方 Over-the-Air Distribution（OTAD）全球重钥网络的时间线高度吻合。这意味着过去近 20 年里，每一颗工作中的 GPS 卫星都在向公众广播密文，但只有持有对应密钥的军事接收机才能解密使用。其机制在于：公开广播的覆盖范围足以触达全球任意地点的授权设备，从而把密钥分发问题从“专人递送”转化为“信号覆盖”问题。
...
Murdoch 在十多年前首次注意到 Subframe 4, Page 17 中的数据呈现出异常的随机性：自然界信号极少会完全随机，而在通信协议中遇到高度熵值的数据，往往意味着加密或刻意混淆。他和同事后续从 GFZ Potsdam 的公开 GNSS 导航位归档中提取了 3994 个不重复的 176 位消息，并通过统计特征确认了这些消息与 OTAD 网络的活动节律一致。这一发现提示，在协议逆向、固件审计或信号监测中，对“保留字段”“未文档化字段”做熵分析，常能先于官方说明发现隐藏信道。

见：[The Empty Field that Wasn't: GPS, OTAD and Two Decades of Encrypted Broadcasts](https://insidegnss.com/the-empty-field-that-wasnt-gps-otad-and-two-decades-of-encrypted-broadcasts/)、[The U.S. Military Quietly Turned GPS Into a Global ‘Numbers Station,’ Evidence Suggests](https://www.404media.co/the-u-s-military-quietly-turned-gps-into-a-global-numbers-station-evidence-suggests/)

#### OTAD 把密钥分发从物理递送转为卫星广播

传统上，军用加密密钥的分发依赖安全物流或人工交接，成本高、周期长、且难以覆盖分散部署。美国军方的 Over-the-Air Distribution（OTAD）及其重钥机制 Over-the-Air Rekeying（OTAR）则利用 GPS 卫星的公开广播向全球授权接收机远程下发密钥。Murdoch 发现，2011 年 5 月 26 日所有 31 颗工作中的 GPS 卫星在数小时内同步广播了相同的 sentinel 模式，这一时间点与解密文件记载的 OTAD 部署时间完全吻合。对大规模分布式系统而言，这种“广播 + 授权解密”的模式把密钥轮换的瓶颈从“人到人”转移到“覆盖到端”，但前提是接收端必须具备可信的密钥存储与解密能力。

见：[The Empty Field that Wasn't: GPS, OTAD and Two Decades of Encrypted Broadcasts](https://insidegnss.com/the-empty-field-that-wasnt-gps-otad-and-two-decades-of-encrypted-broadcasts/)、[The U.S. Military Quietly Turned GPS Into a Global ‘Numbers Station,’ Evidence Suggests](https://www.404media.co/the-u-s-military-quietly-turned-gps-into-a-global-numbers-station-evidence-suggests/)

#### 历史归档数据可暴露隐蔽系统的升级节奏

GFZ Potsdam 自 2007 年起持续归档公开 GNSS 导航位数据，Murdoch 借此梳理出 Subframe 4, Page 17 在近 20 年里的演化阶段：2010 年 2 月出现关键 sentinel 模式，2011 年 5 月全星座同步广播，2022 年起消息轮换速率明显下降，2023 年 12 月开始出现带 "TEXT" 前缀的新格式。这些变化说明，即便系统规格保密，其广播行为在长时间尺度上的统计特征仍会泄露基础设施升级、协议迁移或运维切换。对安全研究而言，持续收集并时间序列化公开信号数据，是推断对手密码基础设施演化的低成本入口。
