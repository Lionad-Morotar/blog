...
特斯拉宣布停产 Model S 和 Model X 两款高端车型，马斯克明确表示"长期中我们将只生产自动驾驶车辆"，将公司重新定位为**交通运输公司**而非汽车制造商。外界批评认为马斯克因畏惧与中国车企竞争而放弃造车，但事实可能是：马斯克只喜欢做"从0到1"、最前沿、无成功先例的事情。电动汽车已成成熟商品，进入成本竞争阶段，这不符合他的风格。相比之下，机器人和自动驾驶车队更符合其"做没人成功过的事"的创业哲学。
...
1950 年的迪拜只是海边沙漠小村庄，1966 年发现石油获得巨额财富。但真正让其持续繁荣的是酋长的一系列制度设计：**（1）免税**，不对外国商人征税；**（2）贸易便利**，给予商人各种便利条件；**（3）基建投入**，将石油收入投入道路、机场、电力、通信、港口；**（4）信仰自由**，不强迫遵守伊斯兰教。石油枯竭后，贸易体系已稳固，城市顺利转型至金融、旅游、房地产等多元产业。
...
二十多年前（21 世纪初）的显卡包装非常花哨复杂，而现在的显卡包装极为简约（如 RTX 5090 公版采用环保材料，体积仅为 RTX 4090 的一半）。变化原因：**（1）环保观念提升**；**（2）显卡供不应求**，一上架即被买走，厂商无需在包装上竞争。这一变化揭示了市场供需关系对产品设计的决定性影响——当需求远大于供给时，营销包装的价值被显著稀释。
