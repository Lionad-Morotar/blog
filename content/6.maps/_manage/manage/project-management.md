...
original_path: content/6.maps/_manage/project-management.md
---
...
一种需求优先级分类方法，用于在时间/资源约束下决定功能取舍。四个等级分别是：

- **Must have**：必须有 — 项目成功所必需的核心功能，没有它项目就无法交付
- **Should have**：应该有 — 重要但非必需的功能，如果时间/资源允许应该包含
- **Could have**：可以有 — 锦上添花的功能，有更好，没有也不影响核心交付
- **Won't have**：不会有 — 明确排除在当前版本/迭代之外的功能，可能留待未来

核心原则是假设时间和资源固定，通过调整功能范围确保交付。Must have 应控制在 60% 以内，超过则说明范围定义不清晰。Won't have 与 Must have 同样重要，明确说"不"能防止范围蔓延。

见：[MoSCoW Method@Wikipedia](https://en.wikipedia.org/wiki/MoSCoW_method)
