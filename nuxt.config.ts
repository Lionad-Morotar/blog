...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      meta: [
        { property: 'og:image', content: `${baseUrl}/images/cover-placeholder.png` },
        { property: 'twitter:image', content: `${baseUrl}/images/cover-placeholder.png` },
  ...
  runtimeConfig: {
    ...
    public: {
      siteUrl: baseUrl,
      defaultCover: `${baseUrl}/images/cover-placeholder.png`
    }
  },
